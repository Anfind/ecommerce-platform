...
const categories = ["Tất Cả", "Electronics", "Fashion", "Home & Kitchen", "Accessories"]
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="inStock" checked={showInStockOnly} onCheckedChange={(checked) => setShowInStockOnly(!!checked)} />
                ...
                <Card key={product.id} className="group hover:shadow-lg transition-shadow">
                  <CardHeader className="p-0">
                    <div className="relative overflow-hidden rounded-t-lg">
                      ...
                      {product.originalPrice && <Badge className="absolute top-2 left-2 bg-red-500">Giảm Giá</Badge>}
                      {!product.inStock && <Badge className="absolute bottom-2 left-2 bg-gray-500">Hết Hàng</Badge>}
                    </div>
                  </CardHeader>
                  ...
                  <CardFooter className="p-4 pt-0">
                    <div className="flex gap-2 w-full">
                      <Button className="flex-1" asChild disabled={!product.inStock}>
